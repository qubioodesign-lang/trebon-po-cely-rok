...
/** Pozadí BRÁNY s automatickým přepínáním dne a noci pro stránku vzkazu */
export function BranaVzkazObal({
  vychoziNocRezim,
  children,
}: BranaVzkazObalProps) {
